...
@section("content")
    <form action="" method="post" class="form-group" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" name="title" placeholder="名称" class="form-group" value="{{old('title')}}">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="date" name="prize_time" placeholder="开奖时间" class="form-group" value="{{old('prize_time')}}">
            </div>
        </div>
        <div class="form-group">
