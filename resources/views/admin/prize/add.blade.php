...
@section("content")
    <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <select class="form-group" name="event_id">
                    <option value="0">请选择活动</option>
                    @foreach($events as $event)
                        @if(date('Y-m-d h:i:s',$event->prize_time) > date('Y-m-d h:i:s',time()))
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" value="{{old('name')}}" class="form-group" placeholder="请输入奖品名称" name="name">
            </div>
        </div>
        <div class="form-group">
