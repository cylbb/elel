...
@section("content")
    <form action="" method="post" class="form-group" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" name="type_accumulation" placeholder="菜品编号" class="form-group" value="{{old('type_accumulation')}}">
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="radio" name="is_selected" class="form-group" value="1" checked>是
                </label>
                <label>
                    <input type="radio" name="is_selected" class="form-group" value="0">否
                </label>
            </div>
        </div>
        <div class="form-group">
