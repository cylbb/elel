...
Route::domain('admin.eleb.com')->namespace('Admin')->group(function () {
    ...
    //商家信息
    Route::get('shop/index',"ShopController@index")->name('shop.index')->name('shop.index');
    Route::any('shop/add',"ShopController@add")->name('shop.add')->name('shop.add');
    Route::any('shop/edit/{id}',"ShopController@edit")->name('shop.edit')->name('shop.edit');
    Route::get('shop/del/{id}',"ShopController@del")->name('shop.del')->name('shop.del');
});
//商家
